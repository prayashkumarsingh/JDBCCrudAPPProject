...
public class TestApp {
	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			...
			System.out.println("PRESS 1.TO CREATE YOUR DATA");
			System.out.println("PRESS 2.TO READ YOUR DATA");
			System.out.println("PRESS 3.TO UPDATE YOUR DATA");
			System.out.println("PRESS 4.TO DELETE YOUR DATA");
			...
			case "5":
				...
				System.exit(0);
			default:
				System.out.println("Invalid Option Entry plz try agin with valid options....");
				break;
			}
